...
class LeaderBoardScreenAdmin extends StatefulWidget {
  const LeaderBoardScreenAdmin({Key? key}) : super(key: key);

  @override
  State<LeaderBoardScreenAdmin> createState() => _LeaderBoardScreenAdminState();
}

class _LeaderBoardScreenAdminState extends State<LeaderBoardScreenAdmin> {
  List<dynamic> users = [];
  bool isLoading = true;
